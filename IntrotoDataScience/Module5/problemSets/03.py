# -*- coding: utf-8 -*-
"""
Created on Mon Dec 22 12:00:40 2014
...
def mapper():
    ...
    for line in sys.stdin:
        ...
        #logging.info(data[1], float(data[6]), data[2], data[3])
...
def reducer():
    ...
    for line in sys.stdin:
        data = line.strip().split("\t") # split on tab
        
        if len(data != 4):
            continue # remove any invalid mapper entries
            
        this_key, date, time, entries = data # set variables for mapper input
