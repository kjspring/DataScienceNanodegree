# -*- coding: utf-8 -*-
"""
Created on Mon Nov 24 17:53:50 2014
...
def simple_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        if passenger['Sex'] == 'female':
            passenger_id = passenger['PassengerId']
            predictions[passenger_id] = 1        
        elif passenger['Sex'] == 'male' and passenger['Pclass'] == 1 and passenger['Age'] < 18 and passenger['Fare'] > 100:
            passenger_id = passenger['PassengerId']
            predictions[passenger_id] = 1
        else:
            passenger_id = passenger['PassengerId']
...
file_path = '/home/kevin/Dropbox/courses/Udacity/DataScience/IntrotoDataScience/Project1/train.csv'
data = simple_heuristic(file_path)